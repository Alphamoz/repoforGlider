// how to update Thread:
// 1. Check for the thread library, to check just include thread, compile and run
// 2. if there is no error then add the code, with the *added in mark
// 3. Check if the function getDVLdata can be threaded.
